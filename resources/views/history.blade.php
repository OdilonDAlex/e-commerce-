...
@section('content')
    <div class="history-container">
        ...
        @forelse($unReadNotifications as $notification)
            <x-history.notification :notification=$notification bgColor="var(--primary-btn)" color="var(--dark-border)"/>
        @empty
        ...
        @forelse($readedNotifications as $notification)
            <x-history.notification :notification=$notification bgColor="var(--secondary-btn)" />
        @empty
